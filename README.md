...
- To clone the repository run this command `git clone https://github.com/BenMukebo/hello-microverse.git`
...
Feel free to check the [issues page](https://github.com/BenMukebo/hello-microverse.git/issues/).
